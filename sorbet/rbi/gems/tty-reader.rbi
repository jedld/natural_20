...
class TTY::Reader
  ...
  def cursor; end
  def env; end
  def get_codes(echo: nil, raw: nil, nonblock: nil, codes: nil); end
  def handle_interrupt; end
  def history_next; end
  def history_next?; end
  def history_previous; end
  def history_previous?; end
  def initialize(input: nil, output: nil, interrupt: nil, env: nil, track_history: nil, history_cycle: nil, history_exclude: nil, history_duplicates: nil); end
  def input; end
  def inspect; end
  ...
  def output; end
  def read_char(echo: nil, raw: nil, nonblock: nil); end
  def read_keypress(echo: nil, raw: nil, nonblock: nil); end
  def read_line(prompt = nil, value: nil, echo: nil, raw: nil, nonblock: nil); end
  def read_lines(prompt = nil, value: nil, echo: nil, raw: nil, nonblock: nil); end
  def read_multiline(prompt = nil, value: nil, echo: nil, raw: nil, nonblock: nil); end
...
class TTY::Reader::History
  ...
  def get; end
  def index; end
  def initialize(max_size = nil, duplicates: nil, cycle: nil, exclude: nil); end
...
class TTY::Reader::Key < Anonymous_Struct_8
...
class TTY::Reader::KeyEvent < Anonymous_Struct_9
...
class TTY::Reader::Console
  ...
  def get_char(echo: nil, raw: nil, nonblock: nil); end
